...
class TrelloCommand(sublime_plugin.TextCommand):
    ...
    def show_quick_panel(self, items, on_done=None, on_highlighted=None, selected_index=-1):
        sublime.set_timeout(lambda: self.view.window().show_quick_panel(
            items, on_done, sublime.MONOSPACE_FONT, selected_index, on_highlighted), 0)
    ...
    def show_output_panel(self, text):
        ...
        self.view.window().run_command(
            "show_panel", {"panel": "output.textarea"})
